...
/**
 * @author yonik
 * @version $Id: Config.java 474625 2006-11-14 02:05:32Z hossman $
 */
public class Config {
    ...
    public Object evaluate(String path, QName type) {
        ...
        try {
            ...
            // TODO: instead of prepending /prefix/, we could do the search
            // rooted at /prefix...
    ...
    private static final String[] packages = { "", "analysis.", "schema.",
            "search.", "update.", "core.", "request.", "util." };
    ...
    public static Class findClass(String cname, String... subpackages) {
        ...
        try {
            ...
            throw new SolrException(500, "Error loading class '" + cname + "'",
                    e, false);
        }
    }
    ...
    public static Object newInstance(String cname, String... subpackages) {
        ...
        try {
            ...
            throw new SolrException(500, "Error instantiating class " + clazz,
                    e, false);
        }
    }
     ...
     * otherwise it will attempt to resolve resources useing any jar files found
     * in the "lib/" directory in the "Solr Home" directory.
     * <p>
     */
            ...
            if (f.canRead() && f.isDirectory()) {
                ...
                try {
                    for (int j = 0; j < jarFiles.length; j++) {
                        ...
                        log.info("Adding '" + jars[j].toString()
                                + "' to Solr classloader");
                    }
                    classLoader = URLClassLoader.newInstance(jars, classLoader);
                } catch (MalformedURLException e) {
                    SolrException.log(log,
                            "Can't construct solr lib class loader", e);
                }
            }
        }
        return classLoader;
