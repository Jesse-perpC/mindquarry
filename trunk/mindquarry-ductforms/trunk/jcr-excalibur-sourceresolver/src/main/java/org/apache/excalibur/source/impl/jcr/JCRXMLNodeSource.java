...
/**
 * A source implementation for an XML-izable JCR Node.
 * 
...
public class JCRXMLNodeSource implements ModifiableSource, XMLizable {
	...
	public JCRXMLNodeSource(JCRXMLSourceFactory factory, Node node)
	...
	public JCRXMLNodeSource(JCRXMLNodeSource parent, Node node)
		...
		try {
			path = getChildPath(parent.path, node.getName());
	...
	public long getContentLength() {
		// we don't know the content length due to dynamic content of xml
		// subtree
		return -1;
	}
	...
	public long getLastModified() {
		...
		// contentNode.setProperty(info.lastModifiedProp, new
		// GregorianCalendar());
	...
	public SourceValidity getValidity() {
		...
		// return prop == null ? null : new
		// JCRNodeSourceValidity(prop.getValue());
		// } catch (RepositoryException re) {
		// return null;
		// }
	}
