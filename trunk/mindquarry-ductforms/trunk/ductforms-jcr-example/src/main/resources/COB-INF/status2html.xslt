...
<xsl:stylesheet version="1.0"
  ...
  <!-- generates context.path variable -->
	<xsl:import href="xslt/html/contextpath.xsl"/>
  ...
  <xsl:template match="status:statusinfo">
    <html>
      <head>
        ...
        <link href="{$context.path}blocks/ductforms-jcr-example/styles/main.css" type="text/css" rel="stylesheet"/>
        <script src="{$context.path}blocks/ductforms-jcr-example/scripts/main.js" type="text/javascript"/>
      </head>
