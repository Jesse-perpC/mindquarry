...
public class JcrPersistenceTest extends JcrPersistenceTestBase {
    ...
    protected void tearDown() throws Exception {
        ...
        String[] entityFolders = new String[] {
                User.PARENT_FOLDER, Team.PARENT_FOLDER, Group.PARENT_FOLDER};
        
        for (String entityFolder : entityFolders) {
            if (rootNode.hasNode(entityFolder))
                rootNode.getNode(entityFolder).remove();
        }
        jcrSession.save();
    ...
    private String testUserContentNodePath() {
        return concat(User.PARENT_FOLDER, "/", 
    ...
    private String testTeamContentNodePath() {
        return concat(Team.PARENT_FOLDER, "/", TEST_TEAM_ID, "/", 
                TEST_TEAM_ID, ".xml", "/" , "jcr:content");
    }
    ...
    public void testPersistCompositeTeamEntity() throws Exception {        
        ...
        assertEquals(team.description, 
                textValueOfChild(contentNode, "description"));
    }
    ...
    public void testPersistUserReferencingTeams() {
        ...
        List<Object> queryResult = 
            currentSession().query("userByLogin", TEST_USER_ID);
