...
public class CollectionTransformer implements Transformer {
    ...
    CollectionTransformer(Type componentType, 
    ...
    public Object readFromJcr(JcrNode jcrNode) {
        Collection<Object> children = newComponentCollection();
    ...
    private Collection<Object> newComponentCollection() {
        try {
            return (Collection<Object>) collectionImplementation_.newInstance();
