...
<xsl:stylesheet version="1.0"
	...
	exclude-result-prefixes="df fd ft fi xhtml">
		...
		<jx:template>
			<xhtml:html>
				<xhtml:head>
					...
					<dformParams>
						<isVirtualNew>${isVirtualNew}</isVirtualNew>
						<documentDoesNotExist>${documentDoesNotExist}</documentDoesNotExist>
						<documentIsNew>${documentIsNew}</documentIsNew>
					</dformParams>
